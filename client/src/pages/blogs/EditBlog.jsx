  ...
  const handleUploadImage = async () => {
    ...
    if (files.length > 0 && files.length + formData.imageURLs.length < 7) {
      ...
      try {
        ...
        setUploadImageError("select atleast one image")
    } else{
      ...
      <div className="flex flex-col md:flex-row mt-4 justify-center md:gap-x-7 text-white mb-20">
        <div className="flex flex-col w-full md:w-[40%] p-6">
          ...
          <p className="text-red-600 mb-4">
            {uploadImagError && uploadImagError}
          </p>
        </div>
        ...
        <div className="flex flex-col w-full md:w-[40%] p-6">
          ...
          <button
            type="submit"
            className="bg-blue-600 text-white py-3 rounded-full text-center font-bold hover:bg-blue-700 uppercase mt-auto"
          >
